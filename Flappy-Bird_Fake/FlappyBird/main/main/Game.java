...
public class Game extends Canvas implements Runnable {
    ...
    public void init() {
        ...
        Sound flap = new Sound();  
        Sound die = new Sound(); 
        Sound hit = new Sound();  
        Sound point = new Sound();                        
        KeyHandler keyHandler = new KeyHandler(flap); 
        ...
        bird = new Bird(50,50,51, 36, hit , die, point);

        startButton = new Button(Game.WIDTH / 2 - 156 / 2, 400, 156, 87, GraphicsLoader.loadGraphics("rcs/newgame.png"));
        existButton = new Button(Game.WIDTH / 2 - 156 / 2, 500, 156, 87, GraphicsLoader.loadGraphics("rcs/quit.png"));
    }
